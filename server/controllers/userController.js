...
exports.signup= async(req,res)=>{
    try{
        ...
        const{name , email , password , gender , mobile, collegeName ,state, district ,year,course }= req.body;

        if(!name || !email || !password || !gender || !mobile || !collegeName || !state ||  !district || !year || !course){
